...
Item {
    ...
    Rectangle {
        id: box
        // The whole sentence, never "…": it wraps onto more lines and the
        // box grows with it (the network notices are full sentences).
        width: Math.min(460, 16 + 18 + 12 + msg.implicitWidth + 16); height: Math.max(48, msg.height + 24); radius: 12
        ...
        Text { id: msg; x: 46; width: parent.width - 62; anchors.verticalCenter: parent.verticalCenter; text: root.text; wrapMode: Text.Wrap; color: Theme.white; font.family: Theme.font; font.pixelSize: 14 }
