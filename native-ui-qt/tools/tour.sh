...
c "eval app.settings.openSection('sources')" "sleep 2" "eval app.settings.activate({arg:'0'}, 'band')" "sleep 3"; s 60-sorgenti-attive
...
echo "— dialoghi"
c "eval app.settings.openSection('timezone')" "sleep 2" "eval app.settings.activate({}, 'timezone')" "sleep 2.5"; s 70-scelta-fuso
c "eval app.dlg.finishPick(-1)" "sleep 1.5" "eval app.settings.openSection('systemControls')" "sleep 2" "eval app.settings.activate({}, 'reboot')" "sleep 2"; s 71-conferma
c "eval app.dlg.finishOk(false)" "sleep 1.5" "eval app.settings.openSection('updates')" "sleep 3" "eval app.settings.activate({}, 'upd_changelog')" "sleep 2"; s 72-novita
c "eval app.dlg.close()" "sleep 1.5" "eval app.settings.openSection('network')" "sleep 2" "eval app.settings.activate({}, 'wifi_panel')" "sleep 5"; s 73-wifi
