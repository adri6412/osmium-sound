// Icons for the file manager, as the inner markup of a 24x24 lucide glyph.
//
// The same set the kiosk draws (native-ui-qt/icons/*.svg), copied here rather
// than fetched: these are four kilobytes of constants, and a <img src> per
// icon would be a request each and could not take `currentColor`. Everything
