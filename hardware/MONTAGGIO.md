...
```
   ...
   │  ○               ○    │
   │      ┌─────────┐      │   ○ = 4 fori Ø5.5
   │      │ SCHERMO │      │   interasse 157 × 115 (da modello del produttore)
   │      └─────────┘      │
   │  ○               ○    │
   └───────────────────────┘
```
...
> dei fori dello schermo è **157 × 115** → prima di montare, allarga a lima/trapano i
> 4 fori del frontale di ~2.5 mm verso l'esterno in orizzontale (e ~1 mm in verticale).
