        ...
        <AnimatePresence>
          {isPlayerExpanded && (
            ...
            >
               ...
               <div className="relative z-40 p-6 flex justify-between items-center">
                 <button
                 ...
                 <div className="text-center flex-1">
                   <p className="text-xs tracking-widest text-hifi-silver uppercase">In Riproduzione</p>
                 </div>
                 <div className="w-12"></div> {/* Spacer for centering */}
               </div>

               {/* Main Expanded Player Content */}
               <div className="relative z-40 flex-1 flex flex-col items-center justify-center p-8 max-w-4xl mx-auto w-full">
                  <motion.div
                    className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-2xl overflow-hidden shadow-2xl mb-12 border border-white/10"
                  ...
                  <div className="text-center w-full mb-10">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 line-clamp-1">
                      {title}
                    </h2>
                    <p className="text-xl md:text-2xl text-hifi-gold mb-2 font-medium truncate">
                      {artist}
                    </p>
                  ...
                  <div className="flex items-center justify-center space-x-12">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-24 h-24 flex items-center justify-center bg-hifi-gold text-black rounded-full shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:shadow-[0_0_40px_rgba(212,175,55,0.5)] transition-shadow"
