...
- **Connection wizard** — first asks what you are connecting to: an Osmium Sound device (paired by QR code, appliance settings shown) or any other Lyrion server (host and port typed in, appliance settings hidden)
